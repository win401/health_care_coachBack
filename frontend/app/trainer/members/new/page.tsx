    ...
    <div className="mx-auto max-w-[1120px] px-5 py-6 md:px-10">
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                {["F", "M", "기타"].map((g) => (
                  <button
                    ...
                    key={g}
                    onClick={() => setGender(g)}
                    className={`h-12 rounded-xl border px-3 text-sm font-black transition-colors ${
                      gender === g
        ...
        <div className="flex justify-end gap-5">
          ...
          <Button type="submit" variant="accent" size="lg" disabled={loading} className="h-12 min-w-36 rounded-xl text-base">
            {loading ? "저장 중..." : "회원 등록"}
          </Button>
        </div>
      </form>
